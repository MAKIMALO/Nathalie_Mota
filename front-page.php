            ...
            <div class="filter-group">
                ...
                <div class="dropdown">
                    ...
                    <label for="category-switch" class="dropdown__options-filter">
                        <span class="dropdown__filter-selected" data-filter="categorie">Catégories</span>
            ...
            <div class="filter-group">
                ...
                <div class="dropdown">
                    ...
                    <label for="format-switch" class="dropdown__options-filter">
                        <span class="dropdown__filter-selected" data-filter="format">Formats</span>
                        <span class="dropdown__arrow"></span>
                        <ul class="dropdown__filter" role="listbox" tabindex="-1">
            ...
            <div class="filter-group">
                <div class="dropdown">
                    ...
                    <label for="date-switch" class="dropdown__options-filter">
                        <span class="dropdown__filter-selected" data-filter="date_order">Trier par</span>
                        <span class="dropdown__arrow"></span>
                        <ul class="dropdown__filter" role="listbox" tabindex="-1">
